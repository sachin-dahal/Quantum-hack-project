...
public class MedRemInfo extends AppCompatActivity {
    ...
    public void delete(View view) {
        ...
        {
            Log.d("DB", "delete: ");
            Toast.makeText(MedRemInfo.this, "Alarm Deleted Successfully", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(MedRemInfo.this,MainActivity.class);
